...
self.addEventListener('fetch', (e) => {
  ...
  // stale-while-revalidate: z cache OD RAZU (<1s), a w tle pobierz świeże
  // (świeżą wersję dostarcza auto-aktualizacja przez nowy service worker)
  e.respondWith(
